...
public interface EdgeWeightedDigraphDAO {
	 ...
	 * @param rotas lista de entidades {@link DirectedEdge} de onde será retirado as informações de origem,
	 ...
	 * aos nós das localidades, convertendo-os em uma entidade {@link DirectedEdge}. Durante a conversão
	 * é atribuido um índice numérico para cada nó encontrado de acordo com a quantidade de nós encontrado. 
	 * Estas informações serão atribuidas nas propriedades da entidade e encapsuladas em um objeto {@link EdgeWeightedDigraph}
	 * correspondente a entidade da malha logísitca.
	 * 
	 * @param nomMapa {@link String} referente ao nome da malha logísitca que será utilizado para criação 
	 * ou recuperação do grafo.
	 * @return entidade {@link EdgeWeightedDigraph} contendo os obejtos {@link DirectedEdge} correspondetes
